...
def main():
    ...
    # Checkpoint
    parser.add_argument('--checkpoint', type=str, default='checkpoint_less', metavar='PATH',
                        help='path to save checkpoint (default: checkpoint_less)')
    parser.add_argument('--resume', action='store_true', default=False,
                        help='resume from checkpoint_less')
